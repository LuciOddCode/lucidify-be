...
class EmailService {
    ...
    async sendTrustedContactNotification(contactEmail, userName, message, language = "en") {
        const templates = {
            en: {
    ...
    async sendWelcomeEmail(userEmail, userName, language = "en") {
        ...
        `,
            ...
            si: {
                subject: "Lucidify වෙත සාදරයෙන් පිළිගනිමු - ඔබේ මානසික සෞඛ්‍ය ගමන ආරම්භ වේ",
                html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        `,
            ...
            ta: {
                subject: "Lucidify க்கு வரவேற்கிறோம் - உங்கள் மனநல பயணம் இங்கே தொடங்குகிறது",
                html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    async sendPasswordResetEmail(userEmail, resetToken, language = "en") {
